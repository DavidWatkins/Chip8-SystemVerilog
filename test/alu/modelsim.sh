...
vlog -sv -work work +incdir+./ C:/Users/David/Sync/Quartus/Chip8-SystemVerilog/test/alu/Chip8_ALU.sv
vlog -sv -work work +incdir+./ C:/Users/David/Sync/Quartus/Chip8-SystemVerilog/test/alu/alu_testbench.sv
#Without -work it compiles in library work

#Run the simulation (assumes top module is compiled in library work)
vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  alu_testbench -do "run 10000ns"

# run 10000ns
#Run a more complex simulation
# vsim -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs=\"+acc\" -t 1ps alu_testbench 
